...
/***/ function(module, exports, __webpack_require__) {
	...
	var _javascriptsContainer = __webpack_require__(158);

	var _javascriptsContainer2 = _interopRequireDefault(_javascriptsContainer);
	...
	_react2["default"].render(_react2["default"].createElement(_javascriptsContainer2["default"], null), document.querySelector("#main"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _timeslider = __webpack_require__(162);

	var _timeslider2 = _interopRequireDefault(_timeslider);

	var _datatable = __webpack_require__(159);
		...
		render: function render() {
			return _react2["default"].createElement(
				...
				_react2["default"].createElement(
					...
					_react2["default"].createElement(_timeslider2["default"], null),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _imagesMapJpg = __webpack_require__(161);
	...
	var Map = (function (_React$Component) {
		function Map() {
			...
			_get(Object.getPrototypeOf(Map.prototype), 'constructor', this).apply(this, args);
			...
			function generateMarkers(num) {
				...
				var pics = ['http://images3.alphacoders.com/199/199875.jpg', 'http://www.unlulerkervani.com/data/media/1021/Sendhil-Ramamurthy_4.jpg', 'https://s-media-cache-ak0.pinimg.com/236x/75/9a/a6/759aa6249d3c3ffb64b34b53f6697105.jpg', 'https://s-media-cache-ak0.pinimg.com/474x/bc/9d/5e/bc9d5e337b511530ccc3fe2eff0ca8c1.jpg', 'http://i.dailymail.co.uk/i/pix/2013/10/10/article-2451604-18A46B5B00000578-415_306x423.jpg'];
				var tweets = ['Life begins when you can spend your spare time programming instead of watching television.', 'I\'ve seen the forgeries I\'ve sent out.', 'jackpot: you may have an unneccessary change record', 'Success covers a multitude of blunders.', 'Danger, you haven\'t seen the last of me!', 'No, but the first of you turns my stomach!'];
				for (var i = 0; i < num; i++) {
				...
				function placeMarkerAndInfoWins(markers) {
					...
					markers.forEach(function (markerData) {
						...
						var infoWin = new google.maps.InfoWindow({
							content: '<h4>' + markerData.handle + '</h4>' + '<img style="width:100px" src="' + markerData.picUrl + '" />' + '<div style="width:100px">' + markerData.tweet + '</div>' + '<button><img style="height:30px" src="https://cdn2.iconfinder.com/data/icons/socal-icon-set/2092/tw.png" /></button>' + '<button><img style="height:30px" src="http://simpleicon.com/wp-content/uploads/retweet.png" /></button>'
						});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "d744f6af90dd43e3dbfff6d40e5f9790.jpg"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bootstrapSlider = __webpack_require__(163);
	...
	var TimeSlider = (function (_React$Component) {
		function TimeSlider(props) {
			...
			_get(Object.getPrototypeOf(TimeSlider.prototype), 'constructor', this).call(this, props);

			var intervalsNum = 72; // 12 hours of 10min intervals
			var tweetsMax = 100; // max amount of tweets per interval
			var intervals = [];

			for (var i = 0; i < intervalsNum; i++) intervals.push(Math.floor(Math.random() * tweetsMax));
		...
		_createClass(TimeSlider, [{
			...
			value: function render() {
				return _react2['default'].createElement(
					'div',
					{ className: 'start_detail' },
					_react2['default'].createElement(
						'div',
						{ className: 'slider_start_label' },
						_react2['default'].createElement(
							'div',
							null,
							'Start'
					...
					_react2['default'].createElement(
						'div',
						{ className: 'slider_timescale', ref: 'sliderTimescale' },
						_react2['default'].createElement(
							'span',
							{ className: 'slider_start_time' },
							this.state.startTime
						),
						_react2['default'].createElement(
							'span',
							{ className: 'slider_finish_time' },
							this.state.finishTime
						),
						_react2['default'].createElement('canvas', { ref: 'sliderCanvas' })
					)
				);
			}
		}, {
			...
			value: function componentDidMount() {
				/* Initialization */
				var self = this;
				var timeScale = _react2['default'].findDOMNode(self.refs.sliderTimescale);
				var sliderCanvas = _react2['default'].findDOMNode(self.refs.sliderCanvas);
				...
				function drawCanvas() {
					...
					function checkAndNormalizePointerPos() {
						...
						if (pointerPos === null) pointerPos = canvasDim.width / 2;
						/* Make it stepwise and check boundaries */
						currInterval = posToIntervalNumber(pointerPos);
						if (currInterval < 0) currInterval = 0;
						if (currInterval >= self.state.intervals.length) currInterval = self.state.intervals.length - 1;
